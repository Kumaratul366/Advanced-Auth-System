    ...
    <div className="min-h-screen bg-[#030712] text-slate-100 flex flex-col justify-between relative overflow-hidden font-sans antialiased selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <section className="flex-1 flex items-center justify-center px-5 py-12 relative z-10 max-w-6xl mx-auto w-full">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-12 lg:gap-24">
          ...
          {/* Left Text Column - Replaced boilerplate copy with project context */}
          <div className="md:w-1/2 lg:w-3/5 text-center md:text-left">
            <div className="inline-flex items-center gap-2.5 mb-5">
              ...
              <span className="text-lg font-black tracking-tight text-white">
                Auth<span className="text-cyan-400">Shield</span> Secure Gateway
              </span>
            </div>
            ...
            <p className="leading-relaxed mt-5 text-slate-400 text-sm md:text-base max-w-lg mx-auto md:mx-0">
              Your login attempt triggers a temporary dynamic verification flow. 
              Please provide your registered account credentials to obtain an encrypted access token.
            </p>
          </div>
          ...
          <div className="w-full md:w-1/2 lg:w-2/5 relative">
            ...
            >
              ...
              <div className="relative mb-5">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    id="email" 
                    name="email" 
                    className="w-full bg-slate-950 rounded-xl border border-slate-800 focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/20 text-sm outline-none text-slate-200 pl-10 pr-4 py-3 transition-all duration-200 placeholder-slate-600" 
              ...
              <div className="mt-6 pt-5 border-t border-slate-900 text-center">
                <Link to={"/register"} className="text-xs font-medium text-slate-500 hover:text-cyan-400 transition-colors">
                  Don't have an account yet? <span className="underline underline-offset-4 font-semibold text-slate-300">Click here to register</span>
                </Link>
              </div>
            </form>
          </div>
